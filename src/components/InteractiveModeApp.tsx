...
export default function InteractiveModePage() {
  ...
  return (
    <div
      className="absolute left-0 top-0 w-screen h-screen flex items-center justify-center text-black"
      ...
      <div className="text-center space-y-12">
        ...
        <div className="grid grid-cols-2 gap-6 max-w-2xl mx-auto p-4">
          <button
            ...
            onClick={() =>
              navigate("/game/cats", {
                state: { from: "/interactive-app-mode" },
              })
            }
          >
            🧠 AI Manipulation
